...
const VARIANTS = {
    Info: {
        base: "bg-white border-blue-500 dark:bg-gray-900 dark:text-gray-400",
    ...
    Error: {
        base: "bg-white border-red-500 dark:bg-gray-900 dark:text-gray-400",
    ...
    Warning: {
        base: "bg-white border-yellow-500 dark:bg-gray-900 dark:text-gray-400",
    ...
    Success: {
        base: "bg-white border-green-500 dark:bg-gray-900 dark:text-gray-400",
