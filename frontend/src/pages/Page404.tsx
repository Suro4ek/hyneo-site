...
const Page404 = () => {
    ...
    return(
        <div className="min-h-screen max-h-full bg-gray-100 dark:bg-gray-900">
            <div className="container mx-auto px-4">
                <section className="py-20 px-4 text-center">
                    <div className="max-w-auto mx-auto">
                        ...
                        <h2 className="mt-8 uppercase text-xl lg:text-5xl font-black">Cтраница не найдена!</h2>
                        <p className="mt-6 uppercase text-sm lg:text-base text-gray-900 dark:text-gray-600">Если вы видете эту страницу значит, вы перешли на страницу которой не существует.</p>
                        <Link to="/"  className="mt-6 bg-blue-500 hover:bg-blue-700 text-white font-light py-4 px-6 rounded-full inline-block uppercase shadow-md">Обратно домой</Link>
                    </div>
                </section>
            </div>
        </div>
